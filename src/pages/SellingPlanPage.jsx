        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-100 bg-slate-50">
              ...
              <th className="text-left px-4 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider w-24">
                Pilih
              </th>
            ...
            {paginatedPlans.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-5 py-4" onClick={(e) => e.stopPropagation()}>
                    <div className="relative">
                      <Button disabled={!isChecked} className="bg-orange-500 hover:bg-orange-600 hover:text-white text-white rounded-full flex items-center gap-1.5 px-4 h-9 cursor-pointer transition-colors">
                        Checkout
                      </Button>
                    </div>
                  </td>
