    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Manage ingredients, stock levels, and alert settings
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <Button
              ...
              variant="outline"
              className="bg-orange-500 hover:bg-orange-600 hover:text-white text-white rounded-full flex items-center gap-1.5 px-4 h-9 cursor-pointer transition-colors"
            >
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[1, 2, 3].map((n) => (
              <div
                key={n}
                className="bg-white border border-slate-200 rounded-3xl p-5 space-y-3 animate-pulse"
              >
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-12 text-center text-slate-500 max-w-lg mx-auto shadow-sm">
            ...
            <div className="flex flex-col items-center gap-3 mt-5">
              <Button
                onClick={handleOpenAdd}
                className="w-48 bg-orange-500 text-white rounded-full cursor-pointer hover:bg-orange-600"
              >
                Add New Item
              </Button>
        ...
        <PlanningModal
          ...
          onCreated={() => {
            // Karena kamu ingin me-refresh halaman,
            // panggil fungsi refetch() yang sudah tersedia di atas
            refetch();
          }}
        />
